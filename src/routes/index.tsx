    ...
    <div className="min-h-screen overflow-x-hidden bg-background text-foreground">
      <header className={`fixed inset-x-0 top-0 z-40 transition-all duration-500 ${scrolled ? "border-b border-border bg-background/95 shadow-sm backdrop-blur" : "bg-transparent"}`}>
        <div className="mx-auto flex h-24 max-w-[1440px] items-center justify-between px-5 sm:px-8 lg:px-14">
          ...
          <div className="flex items-center gap-1.5">
            ...
            <a href="#shop" className="hidden min-h-10 items-center rounded-full bg-foreground px-6 text-xs font-semibold uppercase tracking-[0.16em] text-background transition-colors hover:bg-primary hover:text-primary-foreground sm:inline-flex">Pre-order</a>
      ...
      <main id="top">
          ...
          <div className="mx-auto grid w-full max-w-[1440px] items-center gap-10 px-5 pb-14 sm:px-8 lg:grid-cols-[0.95fr_1.05fr] lg:px-14 lg:pb-8">
            <div className="relative z-10 max-w-2xl animate-rise">
              ...
              <div className="mt-9 flex flex-wrap items-center gap-6">
                <a href="#shop" className="inline-flex min-h-13 items-center rounded-full bg-primary px-8 text-xs font-bold uppercase tracking-[0.16em] text-primary-foreground transition-transform hover:-translate-y-0.5">Pre-order PickyMaax</a>
        ...
        <section id="shop" className="section-pad scroll-mt-20 bg-secondary">
          <div className="mx-auto grid max-w-[1320px] gap-14 px-5 sm:px-8 lg:grid-cols-2 lg:items-center lg:gap-24 lg:px-14">
            ...
            <div className="max-w-xl">
              ...
              <p className="mt-8 text-2xl font-medium">$24 <span className="text-sm font-normal text-muted-foreground">pre-order price</span></p>
              <p className="mt-3 text-sm text-primary">Pre-order now · Ships at launch</p>
              <div className="mt-8 flex flex-col gap-3 sm:flex-row">
                ...
                <Button variant="gold" onClick={addToCart} className="h-13 min-h-13 w-full flex-1 px-8 text-sm shadow-soft">Pre-order · ${(24 * quantity).toFixed(0)}</Button>
              </div>
        ...
        <section className="bg-primary px-5 py-20 text-primary-foreground sm:px-8">
          <div className="mx-auto max-w-3xl text-center"><p className="eyebrow text-primary-foreground/65">First dibs</p><h2 className="mt-4 font-display text-5xl sm:text-6xl">Join the pack.</h2><p className="mt-4 text-primary-foreground/75">Get early launch and restock access, plus the occasional note from Max.</p>
